...
export const store = reactive({
    ...
    comicsList: [
        ...
        },
        {
            ...
            techs: "PHP, Laravel",
            brief: "One of the first approach to Laravel and his charme. We built a simple app that takes input, clean them and stores them. Worked with web routes, CRUDs, forms and storage",
        },
        {
